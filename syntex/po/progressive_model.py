...
if __name__ == "__main__":
    ...
    ps.add("--data-folder", type=str, default="../data")
    ps.add("--save-folder", type=str, default="train_log/single_model")
    ps.add("--steps-per-epoch", type=int, default=10)
    ps.add("--max-epoch", type=int, default=10)
    ps.add("--save-epoch", type=int, default=1)
    ...
    max_epoch = args.get("max_epoch", 10)
